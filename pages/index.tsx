    ...
    <div className="bg-[#091B18] min-h-screen flex flex-col">
          ...
          <div className="stats-container space-y-2">
            <div className="stats-container">
              ...
              <button
                ...
                onClick={handleClick}
                className="bg-gradient-to-br from-orange-500 to-emerald-600 w-full
       px-10 py-5 mt-5 rounded-md text-white shadow-xl font-semibold disabled:text-gray-100
      ...
      <footer className="border-t border-emerald-500/20 flex items-center text-white justify-between p-5">
        ...
        <p className="text-xs text-emerald-900 pl-5">
          DISCLAIMER; the website is published by Robert Edgar ("the
          developer"), the operator of Crypto Lottery. The developer takes all
          reasonable measures to make sure the information is accurate but gives
          no representation or warranty (express or implied) about this site
          including the accuracy or completeness of its contents. You are
          responsible for any decision made by you based on information on this
          site. The developer and its directors, employees or agents accept no
          liability for loss or damage (including, without limitation, any
          special, direct, indirect or consequential loss or damage or other
          ...
          information on this site and the Rules and Procedures for National
          Lottery games (as amended from time to time), the Rules and Procedures
          will take priority.
        </p>
      </footer>
    </div>
